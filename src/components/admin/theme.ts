...
export const buttonPrimaryClass =
  "rounded-full bg-brand-red px-5 py-2 font-nav text-xs font-bold tracking-widest text-brand-black uppercase transition hover:opacity-90 disabled:opacity-50";
