          ...
          {items.map((item, i) => {
            ...
            return (
              <li
                ...
                onClick={() => selectAt(i)}
                className={`cursor-pointer px-3 py-2.5 font-nav text-xs font-semibold tracking-wide uppercase transition-colors duration-150 ${
                  isActive ? "bg-brand-red text-brand-black" : "text-white"
                }`}
              >
                {getLabel(item)}
              </li>
